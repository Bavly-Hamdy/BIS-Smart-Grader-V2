...
const DemoSection: React.FC = () => {
  ...
  return (
    <section id="demo" className="min-h-screen flex items-center bg-slate-50 dark:bg-slate-900 overflow-hidden snap-start py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {steps.map((s, index) => (
              ...
              >
                <motion.div
                  className={`flex items-start p-4 rounded-xl transition-colors duration-300 ${step === index
