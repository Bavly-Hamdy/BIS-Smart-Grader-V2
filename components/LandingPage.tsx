...
const LandingPage: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300 overflow-y-scroll snap-y snap-mandatory selection:bg-primary/20 selection:text-primary scroll-smooth"
      onScroll={handleScroll}
    >
      <Navbar
        customScrolled={isScrolled}
      ...
      {/* --- FEATURES SECTION --- */}
      <section id="features" className="min-h-screen flex items-center snap-start py-24 bg-white dark:bg-slate-900/50 relative">
      ...
      {/* --- CTA SECTION --- */}
      <section className="min-h-screen flex items-center justify-center snap-start py-20 bg-primary-gradient bg-gradient-to-br from-primary to-blue-900 dark:from-slate-900 dark:to-blue-950 text-white relative overflow-hidden">
